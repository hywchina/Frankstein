...
# 配置文件和输出路径
CONFIG_FILE="/home/huyanwei/projects/mergekit/examples/ties.yml"
OUT_PATH="/home/huyanwei/projects/mergekit/merged/ties"

# 可选参数
LORA_MERGE_CACHE="" # 例如 path/to/lora_merge_cache/
TRANSFORMERS_CACHE="" # 例如 path/to/transformers_cache/
